...
use crate::instructions::{ExecResult, HALT, Instruction, InstructionSet, micro};
...
pub static TEST_CPU: InstructionSet = {
    ...
    table[0] = Instruction::Instruction(&[|state| {
        state.set_register_8(Register::A, 0);
        ExecResult::Done(4)
    }]);
    table[1] = Instruction::Instruction(&[|state| {
        state.set_register_8(Register::A, 1);
        ExecResult::Done(4)
    }]);
    table[2] = Instruction::Instruction(&[|state| {
        state.set_register_8(Register::A, 2);
        ExecResult::Done(4)
    }]);
    table[3] = Instruction::Instruction(&[|state| {
        state.set_register_8(Register::A, 3);
        ExecResult::Done(4)
    }]);
    table[4] = Instruction::Instruction(&[|state| {
        state.set_register_8(Register::A, 4);
        ExecResult::Done(4)
    }]);
    table[5] = Instruction::Instruction(&[|state| {
        state.set_register_8(Register::A, 5);
        ExecResult::Done(4)
    }]);
    table[6] = Instruction::Instruction(&[|state| {
        state.set_register_8(Register::A, 6);
        ExecResult::Done(4)
    }]);
    table[7] = Instruction::Instruction(&[|state| {
        state.set_register_8(Register::A, 7);
        ExecResult::Done(4)
    }]);
    table[8] = Instruction::Instruction(&[micro::fetch_byte, |state| {
        state.set_register_8(Register::B, state.get_fetched_byte());
        ExecResult::Done(4)
    }]);
    table[9] = Instruction::Instruction(&[micro::fetch_byte, |state| {
        state.set_register_8(Register::C, state.get_fetched_byte());
        ExecResult::Done(4)
    }]);
    table[10] = Instruction::Instruction(&[micro::fetch_word, |state| {
        state.set_register_16(Register16::DE, state.get_fetched_word());
        ExecResult::Done(4)
    }]);
    table[11] = Instruction::Instruction(&[|state| {
    ...
    table[12] = Instruction::Instruction(&[|state| {
    ...
    table[13] = Instruction::Instruction(&[micro::fetch_word, |state| ExecResult::Store16 {
...
pub static TEST_PREFIX: InstructionSet = [Instruction::Instruction(&[micro::fetch_byte, |state| {
