...
pub fn rlca(state: &mut State, cycles: u8) -> ExecResult<'_> {
    let a = state.a();
...
pub fn rrca(state: &mut State, cycles: u8) -> ExecResult<'_> {
    let a = state.a();
...
pub fn rla(state: &mut State, cycles: u8) -> ExecResult<'_> {
    let acc = state.a();
...
pub fn rra(state: &mut State, cycles: u8) -> ExecResult<'_> {
    let acc = state.a();
